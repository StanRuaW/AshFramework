...
namespace AshFramework.Fsm
{
    ...
    /// 有限状态机管理器。
    /// </summary>
    internal sealed class FsmManager :SingletonMono<FsmManager>, IFsmManager
    {
        ...
        public IFsm<T> CreateFsm<T>(string name, T owner, params FsmState<T>[] states) where T : class
        {
            ...
            if (HasFsm<T>(name))
            {
				Log.E(string.Format("Already exist FSM '{0}'.", typeNamePair));
