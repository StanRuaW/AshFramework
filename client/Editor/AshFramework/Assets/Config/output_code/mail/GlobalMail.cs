...
public sealed partial class GlobalMail :  Plugin.Bright.Config.BeanBase 
{
    ...
    public override string ToString()
    {
        ...
        + "Sender:" + Sender + ","
        + "Content:" + Content + ","
        + "Award:" + Plugin.Bright.Common.StringUtil.CollectionToString(Award) + ","
        + "AllServer:" + AllServer + ","
        + "ServerList:" + Plugin.Bright.Common.StringUtil.CollectionToString(ServerList) + ","
        + "Platform:" + Platform + ","
        + "Channel:" + Channel + ","
