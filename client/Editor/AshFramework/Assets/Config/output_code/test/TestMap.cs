...
public sealed partial class TestMap :  Plugin.Bright.Config.BeanBase 
{
    ...
    public override string ToString()
    {
        return "{ "
        + "Id:" + Id + ","
        + "X1:" + Plugin.Bright.Common.StringUtil.CollectionToString(X1) + ","
        + "X2:" + Plugin.Bright.Common.StringUtil.CollectionToString(X2) + ","
        + "X3:" + Plugin.Bright.Common.StringUtil.CollectionToString(X3) + ","
        + "X4:" + Plugin.Bright.Common.StringUtil.CollectionToString(X4) + ","
        + "}";
    }
    }
