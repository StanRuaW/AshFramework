...
public sealed partial class TestJson2 :  Plugin.Bright.Config.BeanBase 
{
    ...
    public override string ToString()
    {
        return "{ "
        + "Id:" + Id + ","
        + "M1:" + Plugin.Bright.Common.StringUtil.CollectionToString(M1) + ","
        + "M2:" + Plugin.Bright.Common.StringUtil.CollectionToString(M2) + ","
        + "M3:" + Plugin.Bright.Common.StringUtil.CollectionToString(M3) + ","
        + "M4:" + Plugin.Bright.Common.StringUtil.CollectionToString(M4) + ","
        + "}";
    }
    }
