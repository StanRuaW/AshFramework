...
public sealed partial class LevelBonus :  Plugin.Bright.Config.BeanBase 
{
    ...
    public override string ToString()
    {
        return "{ "
        + "Id:" + Id + ","
        + "DistinctBonusInfos:" + Plugin.Bright.Common.StringUtil.CollectionToString(DistinctBonusInfos) + ","
        + "}";
    }
    }
